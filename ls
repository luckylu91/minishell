...
declare -x PWD=/Users/hgallien/goinfre/2
declare -x SHELL=/bin/zsh
declare -x SECURITYSESSIONID=186ae
declare -x TERM_PROGRAM_VERSION=3.4.5
declare -x TERM_PROGRAM=iTerm.app
declare -x PATH=/Users/hgallien/.brew/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/munki:/opt/X11/bin:/Users/hgallien/.fzf/bin
declare -x DISPLAY=/private/tmp/com.apple.launchd.MHWOwGWvTF/org.macosforge.xquartz:0
declare -x LC_TERMINAL=iTerm2
declare -x COLORTERM=truecolor
declare -x COMMAND_MODE=unix2003
declare -x TERM=xterm-256color
declare -x HOME=/Users/hgallien
declare -x TMPDIR=/var/folders/zz/zyxvpxvq6csfxvn_n0009d68002b9k/T/
declare -x USER=hgallien
...
declare -x HOMEBREW_CACHE=/tmp/hgallien/Homebrew/Caches
