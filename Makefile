...
SRCS +=	$(addprefix ast/create_destroy/, create_ast.c create_block.c destroy_block.c dup_block.c destroy_ast.c destroy_binary_ast.c destroy_command_ast.c destroy_redir_ast.c destroy_text_ast.c)
SRCS +=	$(addprefix ast/access/, access_binary.c access_command.c access_redir.c access_text.c)
SRCS +=	$(addprefix execution/, split_path.c)
SRCS +=	$(addprefix execution/ast_exe/, exe_cmd_utils.c ft_builtin.c redir.c exe_cmd.c exe_ast.c exe_cmd_utils_bis.c) 
...
SRCS += $(addprefix block_api/, block_at.c is_chainop.c is_eof.c is_redirop.c is_semicol.c is_space.c is_special.c is_wildcard.c parse_redirop.c is_text.c is_dollar.c is_rawtext.c is_tilde.c)
...
SRCS +=	$(addprefix execution/replace_env/, replace_env.c remove_spaces.c remove_spaces_cmdchain.c our_getenv.c our_getcwd.c replace_env_block.c replace_env_cmd.c replace_env_list.c)
