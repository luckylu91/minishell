...
SRCS += $(addprefix term/, init_termcaps.c init_termios.c termcaps_errors.c termcaps_utils.c bigger_calloc.c linebuffer.c)
...
SRCS += $(addprefix main/, current_line.c redirect_special_key.c)
OBJS = $(SRCS:%.c=%.o)
LIBFT = libft/libft.a
